    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card mb-5" style="max-width: 800px; margin: auto;">
            <div class="card-body">
          ...
          <div class="row mb-5">
            <div class="card mb-4 md-4 col-md-3" style="width: 18rem;">
              <div class="card-body">
                ...
                <a href="laporan" class="btn btn-primary d-flex justify-content-center">Detail</a>
              </div>
            </div>
            <div class="card mb-4 md-4 col-md-3" style="width: 18rem;">
              <div class="card-body">
            ...
            <div class="card mb-4 md-4 col-md-3" style="width: 18rem;">
              <div class="card-body">
                ...
                <h4 class="card-title text-center">Riwayat Data<br> Loker</h4>
                <a href="laporan" class="btn btn-primary d-flex justify-content-center">Detail</a>
              </div>
            </div>
            <div class="card mb-4 md-4 col-md-3" style="width: 18rem;">
