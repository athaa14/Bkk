                            ...
                            <div class="card">
                                <div class="card-body">
                                            ...
                                            <tbody id="alumni-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal-{{ $all->id }}">
                                                            Detail
                                                        </button>
                                                        ...
                                                        <!-- Edit link -->
                                                        <a href="{{ route('editalumni', $all->id) }}" class="btn btn-danger btn-sm">Edit</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                    ...
                                    <div class="d-flex justify-content-left">
                                        {{ $data_alumni->links('vendor.pagination.bootstrap-5') }}
                                    </div>
                                </div>
                            </div>
                        </div>
