                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody id="perusahaan-table">
                                    @foreach ($data_perusahaan as $all)
                                        <tr>
                                            <td class="py-1">{{ $all->nama }}</td>
                                            <td>{{ $all->bidang_usaha }}</td>
                                            <td>{{ $all->no_telepon }}</td>
                                            <td>{{ $all->alamat }}</td>
                                            <td>
                                                <a href="{{ route('editperusahaan', $all->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                                <form action="{{ route('perusahaan.destroy', $all->id) }}" method="POST" style="display:inline-block;">
                                                    @csrf
                                                    @method('DELETE')
