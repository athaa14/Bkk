                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    Nama Pelamar: Herman Back<br> Jenis Kelamin: Laki-Laki <br>Jenis Pekerjaan: IT
                                  </div>
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    Nama Pelamar: Smith<br> Jenis Kelamin: Laki-Laki <br>Jenis Pekerjaan: IT
                                  </div>
                                  <div class="modal-footer">
                                    <<button type="button" class="btn btn-secondary"
                                    data-bs-dismiss="modal">Close</button>
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    Nama Pelamar: John Doe<br> Jenis Kelamin: Laki-Laki <br>Jenis Pekerjaan: IT
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                      data-bs-dismiss="modal">Close</button>
